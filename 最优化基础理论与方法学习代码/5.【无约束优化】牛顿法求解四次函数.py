...
def hesse(vector):  # 求海塞阵的数值,矩阵形式给出
...
def plot_2D_figure(X1, X2, F, x_1_lst, x_2_lst):  # 绘制二维图像并保存
    ...
    plt.savefig('C://Users//张晨皓//Desktop//最优化基础理论与方法学习代码//图片//5.牛顿法2D求解四次函数.png')
    plt.show()
...
def plot_3D_figure(X1, X2, F, x_1_lst, x_2_lst,f_value_lst):  # 绘制三维图像并保存
    ...
    plt.savefig('C://Users//张晨皓//Desktop//最优化基础理论与方法学习代码//图片//5.牛顿法3D求解四次函数.png')
    plt.show()


if __name__ == "__main__":
    vector = np.array([[-0.5], [1.5]])
    vector_x_opt, value, times, x_1_lst, x_2_lst, f_value_lst = newton_method(vector, 0.001)
